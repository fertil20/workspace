...
export default class NewEmployeeEdit extends Component{

    constructor(props) {
        super(props);
        this.state = {
            newEmployeeInfo: {value: ''},
            offices: {value: ''},
            phones: {value: ''}
        }
                ...
                <Col sm={{ size: 5.5 }} style={{backgroundColor: 'white',borderRadius:10,height:'auto',paddingBottom:10, width: '75%'}}>
                    <div style={{width:835}}>
                        <div style={{margin:50,width:750,height:'auto'}}>
                            <Form>
                                <FormGroup>
                                    <Input id='newEmployeeInfo' name='newEmployeeInfo' type='textarea' placeholder="Информация для нового сотрудника"
                                           value={this.state.newEmployeeInfo.value}
                                           style={{height:300}}
